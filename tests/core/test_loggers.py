...
def test_get_request_model_invalid_types() -> None:
    def my_function(param: list[int]) -> list[int]:
        return param
...
def test_get_request_model_invalid_types_union() -> None:
    def my_function(param: Union[list[int], str]) -> str:
        return str(param)
